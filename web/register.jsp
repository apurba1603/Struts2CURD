...
<html>
    ...
    <body>
        ...
        <a href="registerProduct.jsp"><button class="button-report" type="button">Register Product</button></a>
        <a href="productReport"><button class="button-report" type="button">Show Products</button></a>
